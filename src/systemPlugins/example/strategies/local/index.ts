...
export = {
  ...
  async online(options: StrategyOnlineOptions): Promise<void> {
    console.log("system example plugin(local) online with options:", options);
    online = true;
  },

  async offline(): Promise<void> {
    console.log("system example plugin(local) offline");
    online = false;
  },
  ...
  async restart(options: StrategyRestartOptions): Promise<void> {
    ...
    console.log("system example plugin(local) restart with options:", options);
  },
  ...
  async send(options: SendOptions): Promise<unknown> {
    console.log("system example plugin(local) send with options:", options);
    return undefined;
  },
};
